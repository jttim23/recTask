...
import pl.jedro.jsontask.utils.Importer;
...
class ServiceTest {
        ...
        void fileCalculateTest() throws Exception {
            ...
            //when
            Map<String, BigDecimal> map = service.calculate(importer.getPeopleFromJSONFile(input));
            //then
        ...
        void throwsExceptionWhenFileNotFound() {
            ...
            Assertions.assertThrows(Exception.class, () -> {
                service.calculate(importer.getPeopleFromJSONFile(input));
            });
